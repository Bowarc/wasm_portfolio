        ...
        html! {
            ...
            <div id="header">
                ...
                <div id="scene_list" class="header_item">{
                    [ Scene::Home, Scene::GitRepos, Scene::WASMShowcase, Scene::Internships, Scene::Contact, Scene::Void ].iter().map(|scene|{
...
impl App {
    fn start_wormgrid(glctx: WebGlRenderingContext) {
        ...
        *update_fn.borrow_mut() = Some(wasm_bindgen::closure::Closure::wrap(Box::new({
            ...
            let mut wormgrid = component::WormGrid::new(canvas_size);
            move || {
                glctx.clear(
...
impl Scene{
    fn html(&self) -> yew::virtual_dom::VNode{
        match self{
            ...
            Scene::Internships => html!{<><scene::Internships /></>},
...
impl std::fmt::Display for Scene {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Scene::Internships => write!(f, "Internships"),
